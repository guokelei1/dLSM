...
//   }
//
//   Status CreateDir(const std::string& dirname) override { return
//   Status::OK(); }
//
//   Status RemoveDir(const std::string& dirname) override { return
//   Status::OK(); }
//
...
//   system. typedef std::map<std::string, FileState*> FileSystem;
//
//   port::Mutex mutex_;
